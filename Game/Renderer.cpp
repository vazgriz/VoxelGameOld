...
Renderer::Renderer(uint32_t priority, VoxelEngine::Engine& engine, VoxelEngine::CameraSystem& cameraSystem) : VoxelEngine::System(priority) {
    m_engine = &engine;
    ...
    m_triangleRenderer = &m_renderGraph->addNode<TriangleRenderer>(*m_engine, *m_renderGraph, *m_acquireNode, *m_transferNode, cameraSystem);
